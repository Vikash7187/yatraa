...
rl.question('Enter your Railway backend URL (e.g., https://yatraa-production-567e.up.railway.app/): ', (railwayUrl) => {
  rl.question('Enter your Clerk publishable key (pk_test_...): ', (clerkKey) => {
    
    // Update .env file
    const envContent = `# Production Environment Variables
VITE_CLERK_PUBLISHABLE_KEY=${clerkKey}
VITE_API_BASE_URL=${railwayUrl || 'https://yatraa-production-567e.up.railway.app/'}
`;
